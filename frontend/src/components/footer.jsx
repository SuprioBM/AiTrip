        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4 mt-6">
              ...
              <a
                href="#"
                className="w-10 h-10 bg-white/10 hover:bg-teal-500 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold mb-6 text-teal-400">
              Quick Links
            </h4>
